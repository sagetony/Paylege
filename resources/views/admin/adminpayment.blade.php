                                        ...
                                        <tr class="border-bottom">
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger" href="{{Route('adminpayment', ['unconfirmid' => $datadeposit->transaction_id])}} ">Pending Transaction</a>
                                            ...
                                            <div id="myModalDELETED{{$datadeposit->transaction_id}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminpayment', ['deleteid' => $datadeposit->transaction_id]) }}">Delete Transaction</a>
                                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="myModalUNLOCK{{ $datadeposit->transaction_id }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger" href="{{ Route('adminpayment', ['confirmid' =>  $datadeposit->transaction_id]) }}">Confirm Transaction</a>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
