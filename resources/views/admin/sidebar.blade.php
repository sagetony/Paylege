...
<aside class="app-sidebar sidebar-scroll ">
    <div class="main-sidebar-header">
        <a class=" desktop-logo logo-light" href="./"><img src="{{ asset('assett/assets/images/logo.png') }}" width="200" class="main-logo" alt="logo"></a>
        <a class=" desktop-logo logo-dark" href="./"><img src="{{ asset('assett/assets/images/logo.png') }}"width="200" class="main-logo dark-theme" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light" href="./"><img src="{{ asset('assett/assets/images/logo.png') }}" width="200" class="logo-icon" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-dark" href="./"><img src="{{ asset('assett/assets/images/logo.png') }}" width="200" class="logo-icon dark-theme" alt="logo"></a>
    </div>
    <div class="main-sidebar-body circle-animation ">
        ...
        <ul class="side-menu circle">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('adminpayment') }}">Deposits</a></li>
                    <li><a class="slide-item" href="{{ route('adminfunding') }}">Trades</a></li>
